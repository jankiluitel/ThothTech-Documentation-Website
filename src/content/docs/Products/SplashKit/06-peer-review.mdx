...
Conducting peer reviews for Usage examples contains additional steps which can be found
[here](/products/splashkit/documentation/splashkit-website/usage-examples/04-usage-peer-review)
...
6. ### Review the Code
   ...
   - [ ] Relevant media asset included (`.png`, `.gif`, or `.webm` as appropriate)
   ...
   ### Media Asset and Description
   - [ ] The media asset (`.png`, `.gif`, or `.webm`) clearly demonstrates the functionality of the example, where applicable.
   - [ ] The media asset matches the submitted implementation.
